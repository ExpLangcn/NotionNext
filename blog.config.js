...
const BLOG = {
  AUTHOR: 'ExpLang', // 作者
  BIO: '一个苦逼的安全研究人员🍚', // 作者简介
  LINK: 'https://blog.yunjianxx.com', // 网站地址
  AVATAR: '/WechatIMG420.jpeg', // 个人头像 默认取public目录下的avatar.png
  KEYWORDS: 'Explang, hack, 阿浪, 信息安全, 网络安全, 网络攻防, 安全攻防, 信息攻防, 红蓝对抗, 红队技巧, linux, windows, webshell, bypass, 绕waf, 免杀, 二进制分析',  // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  HOME_BANNER_IMAGE: './VIDEO-za-main-home.mp4', // 首页背景大图，默认文件：/public/bg_image.jpg 。会被Notion中的封面图覆盖。
  ...
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHQD53c4CO1IN', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'ExpLangcn/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // gitalk评论插件 更多参考 https://gitalk.github.io/
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'NotionNext', // 你的Github仓库名，例如 'NotionNext'
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'ExpLangcn', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'ExpLangcn', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  // 无关紧要的配置
  TITLE: process.env.NEXT_PUBLIC_TITLE || '❤️ 阿浪的小破站 ❤️', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '一个苦逼的安全研究人员的小破站🍚', // 站点描述，被notion中的页面描述覆盖
